...
function rewrite_home_copy(Dom\HTMLDocument $doc, Dom\Element $container): void
{
    ...
    if ($hero !== null) {
        ...
        dz_home_set_text(
            ...
            'Диагностика, профилактика и лечение для взрослых и детей — спокойно, понятно и по согласованному плану.'
        );
    }
    ...
    if ($services !== null) {
        ...
        $titles = [
            'Стоматология для семьи — с вниманием к возрасту, самочувствию и задачам каждого пациента.',
            'Здоровье начинается с профилактики.',
            'Детский приём без спешки.',
        ...
        $texts = [
            ...
            'Знакомимся с ребёнком, объясняем каждый шаг и даём время освоиться.',
