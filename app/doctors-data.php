...
function doctor_data(): array {
    ...
    $doctors=[
      ...
      [
        'name'=>'Муртазалиева Марет Ахмедовна','slug'=>'murtazalieva-maret-akhmedovna','profession'=>'Врач-стоматолог-терапевт','specializations'=>[1,6],
        'photoLocal'=>'/assets/images/doctor-placeholder.svg','photoAvailable'=>false,'initials'=>'МА',
        'description'=>'Терапевтическая стоматология. Приём взрослых и детей.',
        'intro'=>'Ведёт взрослый и детский терапевтический приём. Обсуждает жалобы, объясняет результаты осмотра и предлагает план лечения с учётом возраста пациента.',
        ...
        'approach'=>['На приёме уделяет внимание понятным объяснениям: что происходит с зубом, какие варианты лечения доступны и как подготовиться к следующему визиту.','Работает со взрослыми и детьми. Объём помощи и последовательность процедур определяются после диагностики.'],
        'competencies'=>[['title'=>'Терапевтический приём','text'=>'Диагностика и лечение заболеваний зубов у взрослых.'],['title'=>'Детская стоматология','text'=>'Терапевтическая помощь детям с учётом возраста и этапа развития зубов.'],['title'=>'Эндодонтическое лечение','text'=>'Дополнительное обучение по лечению корневых каналов и повторному эндодонтическому лечению.']],
        'services'=>['/services/lechenie-kariesa','/services/lechenie-detskogo-cariesa-i-ego-osloznenie','/services/lechenie-kornevyh-kanalov-pod-mikroskopom'],
      ],
      [
      ...
      [
        ...
        'description'=>'Исправление прикуса у взрослых и подростков. Элайнеры и брекет-системы.',
        ...
        'competencies'=>[['title'=>'Лечение на элайнерах','text'=>'3D-сканирование, цифровое планирование и контроль перемещения зубов.'],['title'=>'Брекет-системы','text'=>'Выбор конструкции с учётом клинических показаний и задач лечения.'],['title'=>'Взрослые и подростки','text'=>'Ортодонтическое лечение с учётом возраста, состояния зубов и реставраций.'],['title'=>'Подготовка к восстановлению зубов','text'=>'Согласование положения зубов перед протезированием, реставрацией и имплантацией.']],
    ...
    foreach($doctors as &$doctor){$doctor['clinics']=[1];$doctor['url']='/doctors/'.$doctor['slug'];$doctor['certificates']=$certificates[$doctor['slug']]??[];}unset($doctor);
    return $data=['doctors'=>$doctors,'specializations'=>[['id'=>1,'title'=>'Терапия'],['id'=>2,'title'=>'Хирургия и имплантация'],['id'=>3,'title'=>'Ортопедия'],['id'=>4,'title'=>'Ортодонтия'],['id'=>6,'title'=>'Детский приём']]];
}
