...
function dz_semantic_icon_catalog(): array {
    ...
    $shapes = [
        ...
        'family' => ['Стоматология для взрослых', '<circle cx="8" cy="7" r="3"/><circle cx="17" cy="10" r="2.5"/><path d="M2 21v-4a6 6 0 0 1 12 0v4m0-5a5 5 0 0 1 8 4v1"/>'],
        ...
        'child' => ['Забота о пациентах', '<circle cx="12" cy="13" r="8"/><path d="M12 5c-4 0-4-4-1-4 3 0 4 3 1 4M8 11h.01M16 11h.01M8 15a5 5 0 0 0 8 0"/>'],
