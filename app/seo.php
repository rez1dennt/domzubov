...
function dz_seo_pages(): array {
    $pages = [
        ...
        'services' => ['Услуги стоматологии — Дом Зубов', 'Направления стоматологии «Дом Зубов»: диагностика, лечение зубов, имплантация, протезирование, ортодонтия и детский приём. Информация о процедурах.'],
...
function dz_seo_service_descriptions(): array {
    return [
        'adaptation-visit-for-children' => 'Адаптационный визит к детскому стоматологу: знакомство с врачом и кабинетом, подготовка ребёнка к приёму и ответы на вопросы родителей.',
        'bite-correction' => 'Исправление прикуса у детей: диагностика, выбор ортодонтического аппарата с учётом возраста и этапы наблюдения за ростом зубов и челюстей.',
        ...
        'germetizacia-fisur-y-detei' => 'Герметизация фиссур у детей: показания к защите бороздок жевательных зубов, диагностика перед процедурой и дальнейший уход.',
        ...
        'lechenie-detskogo-cariesa-i-ego-osloznenie' => 'Лечение кариеса и его осложнений у детей: диагностика молочных и постоянных зубов, выбор метода с учётом возраста и подготовка к приёму.',
        ...
        'palatal-expander' => 'Нёбный расширитель: показания к ортодонтическому аппарату, диагностика, подбор конструкции и наблюдение за расширением верхней челюсти.',
        ...
        'profilaktika-i-diagnostika-detei' => 'Профилактика и диагностика зубов у детей: знакомство с врачом, осмотр, раннее выявление изменений и обучение уходу за зубами.',
