...
$checks=['original home sections'=>$sections->length===10,'six adult bento cards'=>$doc->querySelectorAll('[data-section="2"] > div.flex > div')->length===6,'clinic photo mosaic'=>$doc->querySelectorAll('[data-section="3"] img')->length===8,'technology gallery'=>$doc->querySelectorAll('[data-section="4"] img')->length===7,'four named doctors'=>$doc->querySelectorAll('[data-team-card]')->length===4,'one clinic address'=>$doc->querySelectorAll('[data-clinic-tab]')->length===1,'same map layout'=>$doc->querySelectorAll('[data-clinic-map]')->length===1,'reviews four cards layout'=>str_contains($html,'data-review-page-size="4"'),'no old brand'=>!preg_match('/belayaraduga|Бел[а-яё]*\s+Радуг/ui',$html),'no old phone'=>!str_contains($html,'495) 132')];
