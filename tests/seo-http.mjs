...
const xml=await xmlResponse.text(),urls=[...xml.matchAll(/<loc>([^<]+)<\/loc>/g)].map(m=>m[1]);assert.equal(urls.length,54);
...
console.log('PASS: 54 live canonical pages, unique metadata, JSON-LD, XML, staged robots and 301 redirects');
